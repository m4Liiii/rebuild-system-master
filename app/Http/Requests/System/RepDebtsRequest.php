...
class RepDebtsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return match ($this->method()){
            'POST' => [
                ...
                'type_curr' => 'required|min:0|max:3',
                'curr' => 'required|numeric|min:-2147483648|max:2147483647',
                'amount_curr' => 'nullable|numeric|min:-999999999999|max:999999999999',
                'discount_curr' => 'nullable|numeric|min:-2147483648|max:2147483647',
                's_id' => 'nullable',
                'office_id' => 'nullable',
            ],
            'PUT' , 'PATCH' => [
