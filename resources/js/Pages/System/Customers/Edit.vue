...
const form = useForm({
    ...
    alert_of_debt: props.customer.alert_of_debt,
    address: props.customer.address,
    phone_number: props.customer.phone_number,
    type_customer: props.customer.type_customer,
    social_number: props.customer.social_number,
    notice: props.customer.notice,
});
