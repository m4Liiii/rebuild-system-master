        ...
        <div class="flex flex-wrap justify-center flex-initial m-2 ">
          ...
          <div class="px-2 my-3 lg:w-1/4">
            ...
            <TextInput
              id="old_debt"
              type="text"
              :value="formatNumber(customer.debt_customer)"
              class="w-full mt-1"
            ...
            <div class="pr-4 mt-3 lg:w-1/2">
                <div class="flex items-center">
                    ...
                    <label
                      ...
                      >پارە وەرگرتن لە ڕێگەی نوسینگە</label
                    >
                  </div>
            </div>
...
const new_debt = computed(() => {
  return customer.debt_customer - form.amount_of_debt - form.discount;
});
...
const submit = () => {
  form.post(route("customers.getdebts.store" , customer.id));
};
