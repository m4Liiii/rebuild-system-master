      ...
      <div class="p-4 mx-4 rounded-lg shadow-md mb-7 bg-zinc-700">
        <div class="flex flex-wrap justify-center flex-initial m-2">
          ...
          <div class="flex flex-wrap justify-center flex-initial m-2">
            <!-- First Pair -->
            <div class="px-2 my-3 lg:w-1/2">
                <InputLabel for="p_ko" class="relative"> نرخی فرۆشتنی کۆ {{ formatPrice(form.price_of_sell_ko) }}</InputLabel>
                <TextInput
                  id="p_ko"
                  type="text"
                  maxLength="12"
            ...
            <!-- Second Pair -->
            <div class="px-2 my-3 lg:w-1/2">
                <InputLabel for="p_tak" >نرخی فرۆشتنی تاک {{ formatPrice(form.price_of_sell_tak) }}</InputLabel>
                <TextInput
                  id="p_tak"
                  type="text"
                  maxLength="12"
          ...
          <div class="flex flex-wrap justify-center flex-initial m-2">
            <!-- First Pair -->
            <div class="px-2 my-3 lg:w-1/2">
                <InputLabel for="p_buy"  class="relative" >نرخی کڕین {{ formatPrice(form.price_of_buy) }}</InputLabel>
                <TextInput
                  id="p_buy"
                  type="text"
                  maxLength="12"
          ...
          <div class="flex flex-wrap justify-center flex-initial ">
            ...
            <div class="px-2 mt-3 lg:w-1/2">
                <div class="flex items-center">
                    ...
                    <label
                      for="green-checkbox"
                      class="mr-5 text-sm font-medium text-gray-300 text-gray-900"
...
const formatNumber = (number) => {
  return number == null || isNaN(number) ? "-" : numeral(number).format('0.[000]');
};
...
const form = useForm({
  ...
  name_of_product: props.product.name_of_product,
  code_of_product: props.product.code_of_product,
  alert_of_out: props.product.alert_of_out,
  quantity_of_box: props.product.quantity_of_box,
  quantity_of_store: props.product.quantity_of_store,
  price_of_buy: formatNumber(props.product.price_of_buy),
  price_of_sell_tak: formatNumber(props.product.price_of_sell_tak),
  price_of_sell_ko: formatNumber(props.product.price_of_sell_ko),
  ShowSelect: props.product.ShowSelect,
});

const submit = () => {
  form.put(route("categories.products.update" , {category: props.category.id , product:props.product.id} ,{
        preserveScroll: true,
        onError: (errors) => {
            form.errors = errors;
        },
