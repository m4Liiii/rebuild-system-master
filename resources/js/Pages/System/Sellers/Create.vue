<template>
    <Head title="زیادکردنی فرۆشیارەکان" />
      ...
      <div class="p-4 mx-4 rounded-lg shadow-md bg-zinc-700">
        <div class="flex flex-wrap justify-center flex-initial m-2">
          ...
          <div class="px-2 my-3 lg:w-1/2">
            <InputLabel for="name_seller4" value="ناوی فرۆشیار" class="relative" />
            <TextInput
              id="name_seller4"
              type="text"
              maxLength="35"
            ...
            />
            <InputError class="mt-2"  :message="form.errors.name_seller ? 'هەڵە هەیە لە ناوی فرۆشیار' : ''"/>
          </div>

          <!-- Second Pair -->
          <div class="px-2 my-3 lg:w-1/2">
            <InputLabel for="debt" >قەرزی کۆن {{ formatNumber(form.debt_seller) }}</InputLabel>
            <TextInput
              id="debt"
              maxLength="12"
              type="text"
              v-model="form.debt_seller"
              class="w-full mt-1"
              placeholder="قەرزی کۆن (ئارەزوومەندانە , 0)"

            />
            <InputError class="mt-2" :message="form.errors.debt_seller ? 'هەڵە هەیە لە قەرزی کۆن' : ''"/>
          </div>
        </div>
        <div class="flex flex-wrap justify-center flex-initial m-2">
            <!-- First Pair -->
          ...
          <div class="flex flex-wrap justify-center flex-initial m-2">
            <!-- First Pair -->
            <div class="px-2 my-3 lg:w-1/2">
                <InputLabel for="name4" value="جۆری دراو" class="relative" />
                <select id="underline_select" v-model="form.type_curr" class="block py-2.5 px-0 w-full pr-12 text-sm mt-1 text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none  focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                    <option class="text-gray-700 bg-gray-200 " :value="0">USD</option>
                    <option class="text-gray-700 bg-gray-200 " :value="1">IQD</option>
                    <option class="text-gray-700 bg-gray-200 " :value="2">IRR</option>
                    <option class="text-gray-700 bg-gray-200 " :value="3">TRY</option>
                </select>
                <InputError class="mt-2"  :message="form.errors.type_curr ? '  هەڵە هەیە لە جۆری دراو' : ''"/>
              </div>
