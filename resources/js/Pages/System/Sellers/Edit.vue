...
const form = useForm({
    name_seller: props.seller.name_seller,
    address: props.seller.address,
    phone_number: props.seller.phone_number,
    social_number: props.seller.social_number,
    notice: props.seller.notice,
    type_delete: "1",
});
